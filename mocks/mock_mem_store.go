...
// Source: github.com/ShvetsovYura/metrics-collector/internal/storage/file (interfaces: MemoryStore)
...
func (m *MockMemoryStore) GetCounter(arg0 context.Context, arg1 string) (metric.Counter, error) {
	m.ctrl.T.Helper()
...
func (m *MockMemoryStore) GetCounters(arg0 context.Context) map[string]metric.Counter {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCounters", arg0)
	ret0, _ := ret[0].(map[string]metric.Counter)
	return ret0
}
...
func (m *MockMemoryStore) GetGauge(arg0 context.Context, arg1 string) (metric.Gauge, error) {
	m.ctrl.T.Helper()
...
func (m *MockMemoryStore) GetGauges(arg0 context.Context) map[string]metric.Gauge {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetGauges", arg0)
	ret0, _ := ret[0].(map[string]metric.Gauge)
	return ret0
}
